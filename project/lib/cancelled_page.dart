      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(
              child: Text('Error retrieving cancelled orders'),
            );
          }
          ...
          if (orders == null || orders.isEmpty) {
            return Center(
              child: Text('No cancelled orders yet'),
            );
          }
        ...
        builder: (context, snapshot) {
          ...
          if (orders != null && orders.isNotEmpty) {
            return Container(
              ...
              child: Text(
                'Sorry, but these items are not available at the moment. Please try again later.',
