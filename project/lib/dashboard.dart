  ...
  void initState() {
    ...
    filteredProducts.addAll([
      Product(
        ...
        imageUrl: 'https://cdn.shopify.com/s/files/1/1974/9033/products/1_5a7c9552-6e97-4254-802d-b975c33684ae_1024x1024.jpg?v=1634197017',
        price: 61.99,
      ),
      Product(
        name: 'Fantech Pantheon RGB Optical Switch Mechanical Keyboard MK882',
        imageUrl: 'https://monaliza.com.my/wp-content/uploads/2019/12/FANTECH-MK882-PANTHEON-RGB-OPTICal-SWITCH-MECHANICAL-KEYBOARD.png',
        price: 19.99,
      ),
    ]);
  }
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              delegate: ProductSearchDelegate(filteredProducts: filteredProducts,
              ),
              );
            },
          ),
